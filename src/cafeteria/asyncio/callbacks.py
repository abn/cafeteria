...
class Callback:
    ...
    def __init__(self, function: CallbackType, *args: Any, **kwargs: Any) -> None:
        self.function = function
        self.args = args
        self.kwargs = kwargs

    def trigger(self, *args: Any, **kwargs: Any) -> CallbackResultType:
        """
...
CallbackType = Callable[..., Any] | Coroutine[Any, Any, Any] | Callback
...
class SimpleTriggerCallback(Callback):
    ...
    def trigger(self, *_: Any, **__: Any) -> CallbackResultType:
        """
...
def trigger_callback(callback: CallbackType, *args: Any, **kwargs: Any) -> CallbackResultType:
    """
    ...
    if inspect.iscoroutinefunction(callback):
        try:
            ...
            logger.warning("Callback triggered without a running loop, skipping %s", callback)
            return None
    elif callable(callback):
        fn = cast(Callable[..., Any], callback)
        try:
...
class CallbackRegistry(LoggedObject):
    def __init__(
        self,
        callbacks: dict[EventType, CallbackType | list[CallbackType]] | None = None,
    ) -> None:
        self._callbacks: dict[EventType, list[Callback]] = {}
    ...
    def dispatch(self, event_type: EventType, *args: Any, **kwargs: Any) -> None:
        """
